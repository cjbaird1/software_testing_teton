...
class TestSmoketestingv16():
  ...
  def test_joinpage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1252, 1040)
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("test lname")
    self.driver.find_element(By.NAME, "bizname").send_keys("busname")
